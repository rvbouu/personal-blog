...
const darkMode = localStorage.getItem('darkMode') || 'light'; // if key isn't found in localStorage, sets darkMode to 'light'
const toggleDark = localStorage.getItem('toggleDark') || '☀️';
